  ...
  return (
    <>
      <div className="absolute inset-0 z-30 flex">
        {/* Panel */}
        <div className="w-72 h-full border-r border-stone-200 dark:border-stone-800 bg-stone-50 dark:bg-stone-900 flex flex-col shrink-0 shadow-lg animate-[slideInLeft_150ms_ease-out]">
        ...
        {/* Backdrop */}
        <div
          className="flex-1 bg-black/20 animate-[fadeIn_150ms_ease-out]"
          onClick={onClose}
        />
      </div>
